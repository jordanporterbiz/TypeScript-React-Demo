...
To get started, clone the repository by typing the following 'git clone https://github.com/jordanporterbiz/TypeScript-React-Demo.git' command in your terminal. 
